...
const (
	...
	UserAttributeNameDescription         elemental.AttributeSpecificationNameKey = "user/description"
	...
	UserAttributeNameOwner               elemental.AttributeSpecificationNameKey = "user/owner"
...
type User struct {
	...
	ParentID            string            `json:"-" cql:"parentid,omitempty"`
...
var UserAttributesMap = map[elemental.AttributeSpecificationNameKey]elemental.AttributeSpecification{
	...
	UserAttributeNameDescription: elemental.AttributeSpecification{
		AllowedChoices: []string{},
		Exposed:        true,
		Format:         "free",
		Name:           "description",
	...
	UserAttributeNameOwner: elemental.AttributeSpecification{
		AllowedChoices: []string{},
		Exposed:        true,
		Name:           "owner",
		Stored:         true,
