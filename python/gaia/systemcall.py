...
class SystemCall(RESTObject):
    """ Represents a SystemCall in the 
    ...
    def __init__(self, **kwargs):
        """ Initializes a SystemCall instance
          ...
          Examples:
              >>> systemcall = SystemCall(id=u'xxxx-xxx-xxx-xxx', name=u'SystemCall')
              >>> systemcall = SystemCall(data=my_dict)
        """
...
systemcallIdentity = {"name": "systemcall", "category": "systemcalls", "constructor": SystemCall}