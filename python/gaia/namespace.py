...
class Namespace(RESTObject):
    ...
    def __init__(self, **kwargs):
        """ Initializes a Namespace instance
          ...
          Examples:
              >>> namespace = Namespace(id=u'xxxx-xxx-xxx-xxx', name=u'Namespace')
              >>> namespace = Namespace(data=my_dict)
        """
        ...
        self.expose_attribute(local_name="authenticator", remote_name="authenticator")
...
namespaceIdentity = {"name": "namespace", "category": "namespaces", "constructor": Namespace}