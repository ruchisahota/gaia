...
class Certificate(RESTObject):
    """ Represents a Certificate in the 

        Notes:
            Certificate manages certificate creation for users.
    """
    ...
    def __init__(self, **kwargs):
        """ Initializes a Certificate instance
          ...
          Examples:
              >>> certificate = Certificate(id=u'xxxx-xxx-xxx-xxx', name=u'Certificate')
              >>> certificate = Certificate(data=my_dict)
        """
        ...
        self.expose_attribute(local_name="expirationDate", remote_name="expirationDate")
    ...
    def validate(self):
        ...
        err = validate_required_time("expirationDate", self.expirationDate)
...
certificateIdentity = {"name": "certificate", "category": "certificates", "constructor": Certificate}