...
type TrustedCA struct {
	...
	// The platform that this certificate or CA was issued from.
	Platform string `json:"platform,omitempty" msgpack:"platform,omitempty" bson:"-" mapstructure:"platform,omitempty"`
