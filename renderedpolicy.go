...
type RenderedPolicy struct {
	...
	// UserAccessPolicies lists all the policies attached to the user unit.
	UserAccessPolicies PolicyRulesList `json:"userAccessPolicies" msgpack:"userAccessPolicies" bson:"-" mapstructure:"userAccessPolicies,omitempty"`
...
func NewRenderedPolicy() *RenderedPolicy {
	...
	return &RenderedPolicy{
		...
		MatchingTags:       []string{},
		Scopes:             []string{},
		UserAccessPolicies: PolicyRulesList{},
	}
}
...
func (o *RenderedPolicy) ToSparse(fields ...string) elemental.SparseIdentifiable {
	...
	if len(fields) == 0 {
		...
		return &SparseRenderedPolicy{
			...
			Scopes:             &o.Scopes,
			UserAccessPolicies: &o.UserAccessPolicies,
		}
	}
	...
	for _, f := range fields {
		...
		case "scopes":
			sp.Scopes = &(o.Scopes)
		case "userAccessPolicies":
			sp.UserAccessPolicies = &(o.UserAccessPolicies)
		}
	}
...
func (o *RenderedPolicy) Patch(sparse elemental.SparseIdentifiable) {
	...
	if so.UserAccessPolicies != nil {
		o.UserAccessPolicies = *so.UserAccessPolicies
	}
}
...
func (o *RenderedPolicy) Validate() error {
	...
	for _, sub := range o.UserAccessPolicies {
		if sub == nil {
			continue
		}
		if err := sub.Validate(); err != nil {
...
present in HTTP requests.`,
	...
	"UserAccessPolicies": elemental.AttributeSpecification{
		AllowedChoices: []string{},
		Autogenerated:  true,
		ConvertedName:  "UserAccessPolicies",
		Description:    `UserAccessPolicies lists all the policies attached to the user unit.`,
		Exposed:        true,
...
type SparseRenderedPolicy struct {
	...
	// UserAccessPolicies lists all the policies attached to the user unit.
	UserAccessPolicies *PolicyRulesList `json:"userAccessPolicies,omitempty" msgpack:"userAccessPolicies,omitempty" bson:"-" mapstructure:"userAccessPolicies,omitempty"`
...
func (o *SparseRenderedPolicy) ToPlain() elemental.PlainIdentifiable {
	...
	if o.UserAccessPolicies != nil {
		out.UserAccessPolicies = *o.UserAccessPolicies
	}
