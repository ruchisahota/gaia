...
func (o *ExternalService) Validate() error {
	...
	if err := elemental.ValidatePattern("port", o.Port, `^([1-9]|[1-9][0-9]|[1-9][0-9]{1,3}|[1-5][0-9]{4}|6[0-4][0-9]{3}|65[0-4][0-9]{2}|655[0-2][0-9]|65535)(:([1-9]|[1-9][0-9]|[1-9][0-9]{1,3}|[1-5][0-9]{4}|6[0-4][0-9]{3}|65[0-4][0-9]{2}|655[0-2][0-9]|65535))?$`, `must be a valid single number between 1 and 65535 or port range made or two number separated by a colon`, false); err != nil {
		errors = append(errors, err)
	}
	...
	if err := elemental.ValidatePattern("protocol", o.Protocol, `^(TCP|UDP|tcp|udp|[1-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])$`, `must be a valid IANA protocol number or TCP or UDP`, true); err != nil {
		errors = append(errors, err)
	}
