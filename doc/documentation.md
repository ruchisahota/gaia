...
##### `data` (map_of_string_of_lists_of_maps_of_string_of_objects)
...
##### `policies` ([][policyrule](#policyrule))
...
| Characteristics | Value                                                                                                                                    |
| -               | -:                                                                                                                                       |
| Allowed Value   | `APIAuthorization, EnforcerProfile, File, Hook, NamespaceMapping, Network, ProcessingUnit, Quota, Syscall, TokenScope, SSHAuthorization` |
| Required        | `true`                                                                                                                                   |
...
| Characteristics | Value                                                                                                                                                                                                         |
| -               | -:                                                                                                                                                                                                            |
| Allowed Value   | `APIAuthorization, AuditProfileMapping, EnforcerProfile, File, Hook, HostServiceMapping, NamespaceMapping, Network, ProcessingUnit, Quota, Service, ServiceDependency, Syscall, TokenScope, SSHAuthorization` |
| Creation only   | `true`                                                                                                                                                                                                        |
...
##### `egressPolicies` (_rendered_policy)
...
##### `hashedTags` (map_of_string_of_strings)
...
##### `ingressPolicies` (_rendered_policy)
...
##### `profile` (map_of_string_of_strings)
...
##### `services` ([][processingunitservice](#processingunitservice))
...
| Characteristics | Value                                                           |
| -               | -:                                                              |
| Allowed Value   | `Unknown, Deploying, Initializing, Running, Undeploying, Error` |
| Default         | `"Unknown"`                                                     |
| Read only       | `true`                                                          |
| Orderable       | `true`                                                          |
...
##### `authorized` (map_of_string_of_booleans)
...
##### `authorizations` (map_of_string_of_list_of_strings)
...
##### `output` (_elemental_identifiable)
...
##### `claims` (map_of_string_of_list_of_strings)
...
##### `edges` (map[string][graphedge](#graphedge))
...
##### `groups` (map[string][graphgroup](#graphgroup))
...
##### `nodes` (map[string][graphnode](#graphnode))
...
##### `records` (map_of_string_of_strings)
...
##### `fields` (map_of_string_of_strings)
...
##### `results` ([][timeseriesqueryresults](#timeseriesqueryresults))
