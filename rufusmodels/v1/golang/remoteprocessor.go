...
type RemoteProcessor struct {
	...
	InputData interface{} `json:"inputData" bson:"-"`
	...
	OutputData interface{} `json:"outputData" bson:"-"`
...
func (o *RemoteProcessor) Validate() error {
	...
	if err := elemental.ValidateRequiredExternal("inputData", o.InputData); err != nil {
