...
type InstalledApp struct {
	...
	AppIdentifier string `json:"-" msgpack:"-" bson:"appidentifier" mapstructure:"appIdentifier,omitempty"`
	...
	DeploymentCount int `json:"-" msgpack:"-" bson:"deploymentcount" mapstructure:"deploymentCount,omitempty"`
...
type SparseInstalledApp struct {
	...
	// AppIdentifier retains the identifier for the app.
	AppIdentifier *string `json:"-" msgpack:"-" bson:"appidentifier,omitempty" mapstructure:"appIdentifier,omitempty"`
	...
	// DeploymentCount represents the number of expected deployment for this app.
	DeploymentCount *int `json:"-" msgpack:"-" bson:"deploymentcount,omitempty" mapstructure:"deploymentCount,omitempty"`
