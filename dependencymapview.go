...
const (
	...
	DependencyMapViewAttributeNameOwner          elemental.AttributeSpecificationNameKey = "dependencymapview/owner"
...
var DependencyMapViewAttributesMap = map[elemental.AttributeSpecificationNameKey]elemental.AttributeSpecification{
	...
	DependencyMapViewAttributeNameOwner: elemental.AttributeSpecification{
		AllowedChoices: []string{},
		Exposed:        true,
		Name:           "owner",
		Stored:         true,
