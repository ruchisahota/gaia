...
type Authenticator struct {
	...
	Method AuthenticatorMethodValue `json:"method" bson:"method"`
...
func (o *Authenticator) GetStatus() gaiaconstants.EntityStatus {
	return o.Status
}

// SetStatus set the given status of the receiver
func (o *Authenticator) SetStatus(status gaiaconstants.EntityStatus) {
	o.Status = status
}
...
var AuthenticatorAttributesMap = map[string]elemental.AttributeSpecification{
	...
	"Method": elemental.AttributeSpecification{
		...
		CreationOnly:   true,
		DefaultValue:   AuthenticatorMethodValue("Certificate"),
