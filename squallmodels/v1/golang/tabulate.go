...
type Tabulate struct {
	// Colums contains the list of tags key you want to use for generating tabulated data.
	Columns []string `json:"columns" bson:"-"`

	// Data contains the tabulated data.
	Data [][]interface{} `json:"data" bson:"-"`

	// TargetIdentity contains the request target identity data to tabulate.
...
var TabulateAttributesMap = map[string]elemental.AttributeSpecification{
	"Columns": elemental.AttributeSpecification{
	...
	"TargetIdentity": elemental.AttributeSpecification{
		AllowedChoices: []string{},
		Description:    `TargetIdentity contains the request target identity data to tabulate.`,
		Exposed:        true,
		Format:         "free",
		Name:           "targetIdentity",
		Required:       true,
