...
tags: [Api,Squall]
summary: "Tabulate API allows you to retrieve a custom table view for any identity using any tags you like as columns."
sidebar: squall_sidebar
permalink: squall_tabulation.html
folder: apidoc
---
...
```apoctl
apoctl api list tabulations -n /namespace
```
...
func main() {
  ...
  var objects squallmodels.TabulationsList
...
from squallmodels import Tabulation
