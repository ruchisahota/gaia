...
type Layer struct {
	...
	ImageIDs []string `json:"imageIDs" cql:"imageids,omitempty" bson:"imageids"`
...
func (o *Layer) GetNormalizedTags() []string {
	return o.NormalizedTags
}

// SetNormalizedTags set the given normalizedTags of the receiver
func (o *Layer) SetNormalizedTags(normalizedTags []string) {
...
var LayerAttributesMap = map[string]elemental.AttributeSpecification{
	...
	"ImageIDs": elemental.AttributeSpecification{
		AllowedChoices: []string{},
		Autogenerated:  true,
		Exposed:        true,
		Filterable:     true,
