...
type AppCredential struct {
	...
	CertificateSN string `json:"-" msgpack:"-" bson:"certificatesn" mapstructure:"certificateSN,omitempty"`
...
type SparseAppCredential struct {
	...
	// Link to the certificate created for this app credential.
	CertificateSN *string `json:"-" msgpack:"-" bson:"certificatesn,omitempty" mapstructure:"certificateSN,omitempty"`
