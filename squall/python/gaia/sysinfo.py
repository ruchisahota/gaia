...
class Sysinfo(RESTObject):
    """ Represents a Sysinfo in the 

        Notes:
            A SysInfo contains the status and various information about the Server.
    """

    def __init__(self, **kwargs):
        """ Initializes a Sysinfo instance
          ...
          Examples:
              >>> sysinfo = Sysinfo(id=u'xxxx-xxx-xxx-xxx', name=u'Sysinfo')
              >>> sysinfo = Sysinfo(data=my_dict)
        """
    ...
    # sysinfoIdentity represents the Identity of the object
sysinfoIdentity = {"name": "sysinfo", "category": "sysinfos", "constructor": Sysinfo}