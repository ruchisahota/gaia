...
type Automation struct {
	...
	// Status contains the status of the last run.
	Status string `json:"status" bson:"status" mapstructure:"status,omitempty"`

	// StdErr contains the last run sandard error.
	StdErr string `json:"stdErr" bson:"stderr" mapstructure:"stdErr,omitempty"`
...
var AutomationAttributesMap = map[string]elemental.AttributeSpecification{
	...
	"Status": elemental.AttributeSpecification{
		...
		Description:    `Status contains the status of the last run.`,
		Exposed:        true,
		Format:         "free",
		Name:           "status",
		ReadOnly:       true,
	...
	"StdErr": elemental.AttributeSpecification{
		AllowedChoices: []string{},
		Autogenerated:  true,
		ConvertedName:  "StdErr",
