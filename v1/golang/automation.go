...
type Automation struct {
	...
	// OutputIdentities contains the declaration of what kind of ojbect will eventually be modified by the functions. This is used to perform some validations to avoid creating a feedback loop. Only identities declared here can be created, updated or deleted.
	OutputIdentities map[elemental.Operation][]string `json:"outputIdentities" bson:"outputidentities" mapstructure:"outputIdentities,omitempty"`
...
func NewAutomation() *Automation {
	...
	return &Automation{
		...
		OutputIdentities: map[elemental.Operation][]string{},
...
var AutomationAttributesMap = map[string]elemental.AttributeSpecification{
	...
	"OutputIdentities": elemental.AttributeSpecification{
		AllowedChoices: []string{},
		ConvertedName:  "OutputIdentities",
		Description:    `OutputIdentities contains the declaration of what kind of ojbect will eventually be modified by the functions. This is used to perform some validations to avoid creating a feedback loop. Only identities declared here can be created, updated or deleted.`,
		Exposed:        true,
		Name:           "outputIdentities",
		Stored:         true,
		SubType:        "automation_output_identities",
		Type:           "external",
	},
