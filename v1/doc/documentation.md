...
| [QuotaCheck](#quotacheck)                                     | This api allows to verify the quota for a given identity in a given namespace       |
...
| Method | URL           | Description                                                |
| -:     | -             | -                                                          |
| `POST` | `/quotacheck` | Verifies if the quota is exceeded for a particular object. |
