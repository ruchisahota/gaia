...
model:
  ...
  description: A Namespace Mapping Policy defines in which namespace aProcessing Unit
    ...
    no matching Namespace Mapping Policy can be found. If one match is found, then
    the Processing will be bumped down to the namespace declared in the policy. If
    it finds in that child namespace another matching Namespace Mapping Policy, then
