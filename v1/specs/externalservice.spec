attributes:
- description: LoadbalancerAddresses represents the list of adresses of the external
  ...
  type: external
- description: 'LoadbalancerPortsMapping is the list of ports mapped by an extenral
...
- allowed_chars: ^([1-9]|[1-9][0-9]|[1-9][0-9]{1,3}|[1-5][0-9]{4}|6[0-4][0-9]{3}|65[0-4][0-9]{2}|655[0-2][0-9]|65535)(:([1-9]|[1-9][0-9]|[1-9][0-9]{1,3}|[1-5][0-9]{4}|6[0-4][0-9]{3}|65[0-4][0-9]{2}|655[0-2][0-9]|65535))?$
  ...
  description: Port refers to network port which could be a single number or 100:2000
    to represent a range of ports
  exposed: true
  filterable: true
  name: port
  stored: true
...
- allowed_chars: ^(TCP|UDP|tcp|udp|[1-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])$
  description: Protocol refers to network protocol like TCP/UDP or the number of the
    protocol.
  exposed: true
  filterable: true
  name: protocol
...
model:
  ...
  description: An External Service represents a random network or ip that is not managed
    by the system. They can be used in Network Access Policies in order to allow traffic
    ...
    as address, and 1-65000 for the ports. You will need to use the External Services
    tags to set some policies.
