...
- name: accessEnabled
  description: AccessEnabled defines if the account holder should have access to the
    systems.
  type: boolean
  exposed: true
  stored: true
...
- name: resetPasswordExpiration
  description: ResetPasswordExpiration contains the expiration time for reseting the
    password.
  type: time
  stored: true
  autogenerated: true
